...
export class TodayController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve comprehensive daily astrological summary including horoscope, transits, moon phase, and personalized insights.',
  })
  @ApiQuery({
    name: 'profileId',
    required: false,
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        horoscope: {
          type: 'string',
          example: 'Today brings opportunities for deep transformation...',
        },
        ...
        transits: {
          ...
          items: {
            ...
            properties: {
              ...
              interpretation: {
                type: 'string',
                example: 'Harmonious relationships and creativity',
              },
            },
          },
        },
