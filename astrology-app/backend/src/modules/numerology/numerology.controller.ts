...
export class NumerologyController {
  ...
  @ApiOperation({
    ...
    description:
      'Generate a comprehensive numerology report based on name and birth date. Calculates life path number, destiny number, soul urge, and more.',
  })
  @ApiResponse({
    status: 201,
        ...
        interpretations: {
          ...
          properties: {
            lifePathInterpretation: {
              type: 'string',
              example: 'You are a seeker of truth and wisdom...',
            },
            destinyInterpretation: {
              type: 'string',
              example: 'Your destiny involves creative expression...',
            },
            soulUrgeInterpretation: {
              type: 'string',
              example: 'Your soul seeks spiritual enlightenment...',
            },
            personalityInterpretation: {
              type: 'string',
              example: 'Others see you as dynamic and adventurous...',
            },
          },
        },
        strengths: {
          type: 'array',
          items: { type: 'string' },
          example: ['Analytical', 'Spiritual', 'Intuitive'],
        },
        challenges: {
          type: 'array',
          items: { type: 'string' },
          example: ['Overthinking', 'Isolation'],
        },
        careerPaths: {
          type: 'array',
          items: { type: 'string' },
          example: ['Researcher', 'Philosopher', 'Analyst'],
        },
