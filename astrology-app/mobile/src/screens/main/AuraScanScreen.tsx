          ...
          <View style={styles.readingContainer}>
            ...
            {reading.sections.vibe && (
              <View style={styles.sectionCard}>
                <Text style={styles.sectionTitle}>âœ¨ Vibe & Presence</Text>
            ...
            {reading.sections.relationship && (
              <View style={styles.sectionCard}>
                <Text style={styles.sectionTitle}>ğŸ’• Relationship Style</Text>
                <Text style={styles.sectionText}>
                  {reading.sections.relationship}
                </Text>
              </View>
            ...
            {reading.sections.strengths &&
              reading.sections.strengths.length > 0 && (
                <View style={styles.sectionCard}>
                  <Text style={styles.sectionTitle}>ğŸŒŸ Strengths</Text>
            ...
            {reading.sections.watchOuts &&
              reading.sections.watchOuts.length > 0 && (
                <View style={styles.sectionCard}>
                  <Text style={styles.sectionTitle}>âš ï¸ Gentle Watch-Outs</Text>
