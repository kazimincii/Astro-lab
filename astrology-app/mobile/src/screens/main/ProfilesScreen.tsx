...
export default function ProfilesScreen() {
  ...
  const profiles = data ?? [];
  const errorMessage =
    error instanceof Error ? error.message : t('screens.profiles.error');
