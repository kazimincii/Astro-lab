...
export default function MembershipCard({
  ...
  const getPlanName = () => {
    switch (planType) {
      case 'premium':
        return t('plans.premiumPlan.name');
      case 'standard':
        return t('plans.standard.name');
      case 'basic':
      default:
      ...
      >
        ...
        <View style={styles.header}>
          ...
          {isCurrentPlan && (
            <View style={styles.currentBadge}>
              <Text style={styles.currentBadgeText}>{t('plans.plans.current')}</Text>
            </View>
          )}
        </View>
        ...
        {price && (
          <View style={styles.priceContainer}>
            ...
            {trialAvailable && (
              <Text style={styles.trialText}>{t('plans.standard.trial')}</Text>
            )}
          </View>
        )}
        ...
        {!isCurrentPlan && onSelect && (
          ...
          >
            <Text style={[
              ...
              {trialAvailable ? t('plans.upgradeModal.cta.startTrial') : t('plans.plans.selectPlan')}
            </Text>
          </TouchableOpacity>
        )}
      </LinearGradient>
